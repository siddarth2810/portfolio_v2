...
Links: ${renderComponent($$result, "Link", $$Link, { "href": "https://github.com/siddarth2810/rust-compiler" }, { "default": ($$result2) => renderTemplate`GitHub` })} </p> </div> <div class="flex flex-col gap-2"> <p> ${renderComponent($$result, "Link", $$Link, { "href": "https://github.com/Doc-Appointment-System" }, { "default": ($$result2) => renderTemplate`Doc-Appointment System` })} </p> <p class="text-sm">
